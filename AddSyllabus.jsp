       ...
       <div class="container">  
           ...
           <div class="row">
            ...
            <div class="form-group" >
              ...
              <input class="form-control" type="text" placeholder="enter code" id="" name="code" required="true">
             </div>
                  <div class="form-group" >
              ...
              <span class="custom-file-control"></span>
                   ...
                   <br>
             <button type="submit" class="btn btn-primary" name="submit">Add Syllabus</button>      
            </div>
            </div>      
         </div>  
      </form>
